...
<body>
    ...
    <h1>EL</h1>
    <h3><a href="test1">request.getAttribure() 테스트</a> </h3>
    <h3><a href="test2">requset에 저장된 객체 출력 테스트</a> </h3>
    <h3>
        <a href="views/el/testEl3.jsp?name=galaxy&price=95&no=5&no=6&option=삼성">
            parameter로 전달 된 값 출력 테스트
        </a>
    </h3>
    <h3><a href="test4">requestS</a> </h3>

    <h1>JSTL</h1>
    <h3><a href="views/jstl/tesrJstlCore.jsp">Core Library Test</a> </h3>
